 ...
 * this can be translated into {@link org.zkoss.poi.ss.formula.eval.BlankEval} but there are some notable exceptions.  Functions
 * COUNT and COUNTA <em>do</em> count their missing args.  Note - the differences between
 * {@link org.zkoss.poi.ss.formula.eval.MissingArgEval} and {@link org.zkoss.poi.ss.formula.eval.BlankEval} have not been investigated fully, so the POI
