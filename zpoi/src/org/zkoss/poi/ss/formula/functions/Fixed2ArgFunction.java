...
public abstract class Fixed2ArgFunction implements Function2Arg {
	...
	//ZSS-852
	private ValueEval evaluateArray(int srcRowIndex, int srcColumnIndex, ValueEval arg0, ValueEval arg1) {
		...
		return new ArrayEval(results, ae0.getFirstRow(), ae0.getFirstColumn(), ae0.getLastRow(), ae0.getLastColumn());
	}
}
