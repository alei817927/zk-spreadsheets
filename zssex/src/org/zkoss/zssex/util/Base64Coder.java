...
public class Base64Coder {
  ...
  public static String decodeString(String var0) {
    return new String(decode((String)var0));
  }
  ...
  public static byte[] decodeLines(String var0) {
    ...
    for(int var3 = 0; var3 < var0.length(); ++var3) {
      ...
      if(var4 != 32 && var4 != 13 && var4 != 10 && var4 != 9) {
        var1[var2++] = var4;
      }
    }
  ...
  public static byte[] decode(String var0) {
    return decode((char[])var0.toCharArray());
  }
  ...
  public static byte[] decode(char[] var0, int var1, int var2) {
    if(var2 % 4 != 0) {
      ...
      while(var2 > 0 && var0[var1 + var2 - 1] == 61) {
        --var2;
      }
  ...
  static {
    ...
    char var1;
    for(var1 = 65; var1 <= 90; map1[var0++] = var1++) {
      ;
    }

    for(var1 = 97; var1 <= 122; map1[var0++] = var1++) {
      ;
    }

    for(var1 = 48; var1 <= 57; map1[var0++] = var1++) {
      ;
    }
